...
def calculate_demographic_data(print_data=True):
    ...
    # Calculate the percentage of people that earn >50K for each native country
    highest_earning_country = df.loc[df['salary'] == '>50K', 'native-country'].value_counts(normalize=True).idxmax()
    highest_earning_country_percentage = (df.loc[df['native-country'] == highest_earning_country, 'salary'] == '>50K').mean() * 100
...
# Calculate and print demographic data
demographic_data = calculate_demographic_data(print_data=True)
